...
function Header() {
    return (
        <div>
            <header>
                <div class="rounded  d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom my-3 bg-secondary">
                    <Link to={"/"} class="d-flex align-items-center text-white text-decoration-none px-3">
                        ...
                        <span class="fs-4">Find Servise</span>
                    </Link>
